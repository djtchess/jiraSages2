...
export class EpicDurationChartComponent implements OnInit, OnChanges {
  ...
  displayedColumns: string[] = ['epicKey', 'epicSummary', 'status', 'versions', 'storyPoints', 'days', 'developers', 'tickets'];
